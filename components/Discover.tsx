...
const Discover: NextPage = () => {
  ...
  const activeTopicStyle = 'xl:border-2 hover:bg-primary xl:border-[#ed3b47] px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-[#ed3b47]';
  ...
  return (
    <div className='xl:border-b-2 xl:border-gray-400 pb-6'>
